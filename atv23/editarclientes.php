    ...
    <main class="form-page">
      ...
      <form class="form-card" action="./atualizarclientes.php" method="post">
        ...
        <div class="form-row">
          ...
          <input type="number" class="form-control" id="email" name="idade" value="<?php echo $cliente['idade']; ?>">
        </div>
        ...
        <div class="form-row">
          ...
          <input type="tel" class="form-control" id="email" name="telefone" value="<?php echo $cliente['telefone']; ?>">
        </div>
