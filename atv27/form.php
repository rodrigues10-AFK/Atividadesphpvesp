...
<html lang="pt-br">
  ...
  <body>
    <main class="form-page">
      ...
      <form class="form-card" action="./salvarfuncionario.php" method="post">
        ...
        <div class="form-row">
          ...
          <input type="text" class="form-control" id="email" name="cargo"  >
        </div>
        
        <div class="form-row">
          <label for="email" class="form-label">Departamento:</label>
          <input type="text" class="form-control" id="email" name="departamento"  >
        </div>

        <div class="form-row">
          <label for="email" class="form-label">Salário:</label>
          <input type="number" class="form-control" id="email" name="salario"  >
        </div>

        <div class="form-row">
          <label for="email" class="form-label">Data de Admissão:</label>
          <input type="date" class="form-control" id="email" name="admissao"  >
        </div>
